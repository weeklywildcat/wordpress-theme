...
<div class="wp-block-group alignwide linea-story-grid linea-newsroom-grid">
	...
	<div class="wp-block-group linea-newsroom-column linea-latest-column">
		...
		<h2 class="wp-block-heading linea-section-heading">Latest Coverage</h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-query linea-tight-query">
			...
			<!-- wp:query-no-results -->
				...
				<p class="has-small-font-size">Latest coverage will appear here after more posts are published.</p>
				<!-- /wp:paragraph -->
			<!-- /wp:query-no-results -->
		</div>
		<!-- /wp:query -->
	...
	<div class="wp-block-group linea-newsroom-column linea-spotlight-column">
		<!-- wp:heading {"className":"linea-section-heading","level":2} -->
		<h2 class="wp-block-heading linea-section-heading">In Depth</h2>
		<!-- /wp:heading -->

		<!-- wp:query {"query":{"perPage":3,"pages":0,"offset":5,"postType":"post","order":"desc","orderBy":"date","inherit":false},"className":"linea-tight-query"} -->
		<div class="wp-block-query linea-tight-query">
			<!-- wp:post-template -->
			...
			<!-- wp:query-no-results -->
				<!-- wp:paragraph {"fontSize":"small"} -->
				<p class="has-small-font-size">Longer reads and feature stories will appear here.</p>
				<!-- /wp:paragraph -->
			<!-- /wp:query-no-results -->
		</div>
		<!-- /wp:query -->
	...
	<div class="wp-block-group linea-newsroom-column linea-briefs-column">
		<!-- wp:heading {"className":"linea-section-heading","level":2} -->
		<h2 class="wp-block-heading linea-section-heading">Quick Reads</h2>
		<!-- /wp:heading -->

		<!-- wp:query {"query":{"perPage":5,"pages":0,"offset":8,"postType":"post","order":"desc","orderBy":"date","inherit":false},"className":"linea-tight-query"} -->
		<div class="wp-block-query linea-tight-query">
			<!-- wp:post-template -->
				<!-- wp:post-title {"isLink":true,"level":3,"fontSize":"medium"} /-->
				<!-- wp:post-date {"fontSize":"x-small"} /-->
			...
			<!-- wp:query-no-results -->
				<!-- wp:paragraph {"fontSize":"small"} -->
				<p class="has-small-font-size">Short updates will appear here once more stories are available.</p>
				<!-- /wp:paragraph -->
			<!-- /wp:query-no-results -->
		</div>
		<!-- /wp:query -->
